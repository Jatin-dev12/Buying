    ...
    const txGroupsasset = await generateAssetTransferTxns({
      ...
      amount: final_amount
          ...
          try {
            ...
            $.ajax({
              url: 'https://buytokenllc.com/bridge/bep20/ajaxcall/updateBurnTransaction.php',
            type: 'post',
            dataType:"json",
          ...
          $.ajax({
              url: 'https://buytokenllc.com/bridge/bep20/ajaxcall/updateclickstatusbep.php',
            type: 'post',
            dataType:"json",
      ...
      useEffect(() => {
          if(localStorage.getItem('bridgestaketoken') === '' || localStorage.getItem('bridgestaketoken') === null){
            ...
            //$('.loading').css('display','block');
              ...
              // axios.get('https://buytokenllc.com/bridge/bep20/getbuyasa.php')
              // .then(response => {
              ...
              const fetchData = async () => {
                try {
                  const response = await axios.get('https://buytokenllc.com/bridge/bep20/getbuyasa.php', {
  ...
  <div className="col-md-10 content" style={{"display":"block"}}>
    ...
    Request BUY (BEP-20) to BUY (ASA) Tokens
    </div>
